...
/*we are making owners acessor class to get the owners information by accepting owners_no from test class likewise we can create society accessor
 * flat accessor and other accessor classes so all will 
*/
}
